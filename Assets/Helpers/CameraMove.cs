...
public class CameraMove : MonoBehaviour {
	...
	void Update () {
        ...
        {
            if (RightBound == null || (RightBound != null && this.transform.position.z < RightBound.transform.position.z))
            {
        ...
        {
            if (LeftBound == null || (LeftBound != null && this.transform.position.z > LeftBound.transform.position.z))
            {
